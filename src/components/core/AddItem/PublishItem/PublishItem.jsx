...
import {setEditCourse, setStep } from '../../../../slices/itemSlice.jsx';
import { COURSE_STATUS } from '../../../../../utils/constant.js';
import { addItemToCategory, editCourseDetails } from '../../../../services/operations/itemDetailsAPI.js';
...
const PublishCourse = () => {
    ...
    useEffect(() => {
        if(item?.status=== COURSE_STATUS.PUBLISHED) {
    ...
    const handlePublish = async () => {
        try {
            ...
            const isPublished = item?.status === COURSE_STATUS.PUBLISHED;
            const isDraft = item?.status === COURSE_STATUS.DRAFT;
            ...
            const addCourseCategory = await addItemToCategory({ categoryId, courseId: course._id }, token);
    ...
    <div>
        <div className='rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6'>
            ...
            <label htmlFor="public" className="inline-flex items-center text-lg">
                ...
                <span className="ml-2 text-richblack-400">Make this Item as public</span>
            </label>
            </div>
